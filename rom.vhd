...
architecture a_rom of rom is
  ...
  constant conteudo_rom : mem := (
    ...
    23     => B"1111_00000_00010010",  -- JUMP 18
    ...
    31     => B"1111_00000_00011010",  -- JUMP 26
    ...
    39     => B"1111_00000_00100010",  -- JUMP 34
    ...
    45     => B"1100_00000111_0_010",  -- BEQ 7
    46     => B"0101_011_111_000_001", -- MOV R3, A
    46     => B"0101_011_111_000_001", -- MOV R3, A
    47     => B"0010_111_000000001",   -- LD A, 1
    48     => B"0101_111_100_111_111", -- ADD A, A, R4
    49     => B"0101_100_111_000_001", -- MOV R4, A
    50     => B"0101_111_011_000_001", -- MOV A, R3
    51     => B"0101_101_000_000_001", -- MOV R5, R0
    52     => B"0101_111_001_111_111", -- ADD A, A, R1
    53     => B"1001_111_000111111",   -- CMPI A, 63
    54     => B"1100_00000110_1_101",  -- BGE 6
    55     => B"0101_010_111_111_001",  -- MOV R2, A
    56     => B"0010_111_000000010",   -- LD A, 2
    57     => B"0010_001_000000001",   -- LD R1, 1
    58     => B"0010_100_000000010",   -- BGE 6
    59     => B"0101_010_111_111_001",  -- MOV R2, A
    60     => B"0101_111_100_111_001",   -- MOV A, R4
    61     => B"1100_00000111_0_010",  -- CMPI A, 18
    62     => B"0101_011_111_000_001", -- BEQ 2 
    63     => B"0101_111_011_111_001", -- MOV A, R3  
    64     => B"1111_00000_00101011",  -- JUMP 43 
    others => (others => '0')
  );
